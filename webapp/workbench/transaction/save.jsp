	...
	<form class="form-horizontal" action="workbench/transaction/save.do" method="post" id="tranForm" role="form" style="position: relative; top: -30px;">
		...
		<div class="form-group">
			...
			<div class="col-sm-10" style="width: 300px;">
				...
				<input type="hidden" id="create-activityId" name="activityId" value="45fe96d30b9f411f90073e6a26a31730">
			</div>
		</div>
		...
		<div class="form-group">
			...
			<div class="col-sm-10" style="width: 300px;">
				...
				<input type="hidden" id="create-contactsId" name="contactsId" value="889ec90bbbbd4a2f87e7c963938a58e5">
			</div>
		</div>
